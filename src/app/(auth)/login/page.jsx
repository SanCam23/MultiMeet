    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-6 py-8">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl font-bold text-foreground mb-3">Bienvenido a MultiMeet</h1>
          <p className="text-muted-foreground">Conecta con tu comunidad local</p>
        </div>

        <section className="bg-card rounded-3xl shadow-xl p-8 md:p-10 border border-border" aria-label="Iniciar sesión">
