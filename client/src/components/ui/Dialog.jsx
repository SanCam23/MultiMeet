...
const DialogContent = React.forwardRef(({ className, children, ...props }, ref) => (
    <DialogPortal>
        ...
        <DialogPrimitive.Content
            ref={ref}
            className={cn(
                'fixed left-1/2 top-1/2 z-50 w-full max-w-lg -translate-x-1/2 -translate-y-1/2 border border-border bg-card shadow-lg animate-fade-in duration-200 sm:rounded-2xl max-h-[85vh] flex flex-col',
                className
            )}
            {...props}
        >
